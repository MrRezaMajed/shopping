// آدرس، روش ارسال و خلاصه خرید

'use client';
import { useState } from "react";
import AddressList, { Address } from "./components/address/AddressList";
import DeliveryMethods, { DeliveryMethod } from "./components/delivery/DeliveryMethods";
...
export default function CheckoutPage() {
  ...
  return (
    <section className="min-h-screen bg-slate-50/50 dark:bg-slate-950 py-10 px-4 sm:px-6 lg:px-8" dir="rtl">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">

          {/* بخش اصلی راست: انتخاب آدرس و شیوه ارسال */}
