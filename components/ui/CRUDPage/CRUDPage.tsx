  ...
  const handleSubmit = useCallback(
    async (values: any) => {
      ...
      if (!res.success) {
        ...
        addNotification({
          type: "success",
          title: mode === "edit" ? "ویرایش موفقیت‌آمیز" : "ثبت موفقیت‌آمیز",
          message: mode === "edit" ? `${modelName} با موفقیت ویرایش شد` : `${modelName} با موفقیت ایجاد شد`,
          duration: 4000,
        });
        setMode("list");
        setEditingItem(null);
    ...
    [mode, editingItem, model, modelName, refreshList, addNotification]
  );
